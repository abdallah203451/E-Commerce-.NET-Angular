...
namespace Back_End.Infrastructure.Migrations
{
    ...
    [Migration("20240823160244_adding cart and cartItem tables")]
    partial class addingcartandcartItemtables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Back_End.Domain.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Back_End.Domain.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Back_End.Domain.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "5d7eb5c2-17cb-488d-bbd4-63056a8ef1e2",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "cd3d09f3-5069-4a17-b89b-cab4441c7742",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("Back_End.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("Back_End.Domain.Entities.Cart", "Cart")
                        .WithMany("CartItems")
